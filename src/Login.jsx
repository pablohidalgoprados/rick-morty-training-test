    ...
    <>
      <div id="Container">
        <form className="form">
          ...
          <input className="form-content" type="text" placeholder="Username" name="username"
          onChange={(f) => onInputChanges(f)} />
          <input className="form-content" type="password" placeholder="Password" name="password"
          onChange={(f) => onInputChanges(f)} />
          <button className="rounded-md" value="Log In" onClick={() => onSubmit()}>Continuar</button>
        </form>
