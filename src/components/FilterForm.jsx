...
function CharacterFilter({ filters, handleFilterChange }) {
  ...
  return (
    <form className="p-4 mt-8 bg-gray-100 rounded-lg flex flex-col items-center max-w-[600px] mx-auto">
      ...
      <div className="flex flex-wrap justify-center">
      <div className="mr-4">
      <div className="flex flex-col items-start gap-4 overflow-hidden rounded-md p-6 mb-3 shadow-sm shadow-[#00000050]">
        ...
        <div className="flex items-center gap-4">
          <div className="relative flex h-[50px] w-[50px] items-center justify-center">
            ...
            />
            <div className="absolute h-full w-full rounded-full bg-yellow-100 p-4 shadow-sm shadow-[#00000050] ring-yellow-400 duration-300 peer-checked:scale-110 peer-checked:ring-2"></div>
            ...
            <svg
              ...
              className="absolute stroke-yellow-400"
            >
          ...
          <div className="relative flex h-[50px] w-[50px] items-center justify-center">
            <input
              ...
              className="peer z-10 h-full w-full cursor-pointer opacity-0"
            />
            <div className="absolute h-full w-full rounded-full bg-green-100 p-2 shadow-sm shadow-[#00000050] ring-green-400 duration-300 peer-checked:scale-110 peer-checked:ring-2"></div>
            <div className="absolute -z-10 h-full w-full scale-0 rounded-full bg-green-200 duration-500 peer-checked:scale-[500%]"></div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="38"
              height="40"
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="absolute fill-green-400"
            >
          ...
          <div className="relative flex h-[50px] w-[50px] items-center justify-center">
            <input
              ...
              className="peer z-10 h-full w-full cursor-pointer opacity-0"
            />
            <div className="absolute h-full w-full rounded-full bg-red-100 p-2 shadow-sm shadow-[#00000050] ring-red-400 duration-300 peer-checked:scale-110 peer-checked:ring-2"></div>
            <div className="absolute -z-10 h-full w-full scale-0 rounded-full bg-red-200 duration-500 peer-checked:scale-[500%]"></div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="38"
              height="40"
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="absolute fill-red-400"
            >
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <path d="M3 3l18 18" />
